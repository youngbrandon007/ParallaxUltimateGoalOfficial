...
public class Camera {
    ...
    public Camera(OpMode opMode){
        ...
        servo = opMode.hardwareMap.get(Servo.class, "cs");
    }
    ...
    public class ImagePos{
        ...
        public ImagePos(OpenGLMatrix pose){
            ...
            rx = new Angle().setDegrees(rot.firstAngle);
            ry = new Angle().setDegrees(rot.secondAngle);
            rz = new Angle().setDegrees(rot.thirdAngle);
        }
    }
}
